...
export default function ResponderProfileScreen({ profile, onBack, onProfileUpdated }: Props) {
  ...
  async function handlePickAvatar() {
    ...
    try {
      ...
      console.error('[ResponderProfileScreen] avatar upload failed:', err)
  ...
  async function handleSave() {
    ...
    try {
      ...
      console.error('[ResponderProfileScreen] save failed:', err)
  ...
  const dutyLabel = profile.is_on_duty ? 'ON DUTY' : 'OFF DUTY'
  const dutyColor = profile.is_on_duty ? '#10b981' : '#6b7280'
    ...
    <SafeAreaView style={styles.container} edges={['top', 'bottom']}>
      ...
      <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.avatarSection}>
          ...
          <Text style={styles.profileName}>{profile.full_name ?? 'Responder'}</Text>
        ...
        <View style={styles.dutyBanner}>
          <View style={[styles.dutyDot, { backgroundColor: dutyColor }]} />
          <Text style={[styles.dutyText, { color: dutyColor }]}>{dutyLabel}</Text>
          <Text style={styles.dutyNote}>Toggle duty status from your dashboard</Text>
        </View>
        ...
        <View style={styles.formSection}>
          ...
          <View style={styles.fieldGroup}>
            ...
            <View style={[styles.inputWrapper, styles.inputReadOnly]}>
              ...
              <Text style={styles.readOnlyText}>Responder</Text>
            </View>
          </View>
        </View>
